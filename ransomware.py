...
parser . add_argument ( "path" , help = "Path to
encrypt/decrypt, can be a file or an entire folder" )
parser . add_argument ( "-s" , "--salt-size" , help =
...
if args .salt_size:
key = generate_key ( password , salt_size = args
